...
public class Ingredients {
    ...
    public static final Ingredient RAW_ONION = new Ingredient("생양파", 0);
    public static final Ingredient GRILLED_ONION = new Ingredient("구운양파", 0);
    public static final Ingredient BACON = new Ingredient("베이컨", 1000);

    public static final Ingredient KETCHUP = new Ingredient("케첩", 0);
    public static final Ingredient MAYO = new Ingredient("마요", 0);
    public static final Ingredient MUSTARD = new Ingredient("머스타드", 0);
    public static final Ingredient SPICY = new Ingredient("스파이시 소스", 0);
